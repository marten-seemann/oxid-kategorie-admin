...
class window.LanguageHandler
  ...
  setLanguageCookies: ->
    $.cookie("cat_language", @language, { expires: 365 }) # save the selected language in a cookie, valid 365 days
    $.cookie("cat_oxid_language", @oxid_language, { expires: 365 }) # save the selected language in a cookie, valid 365 days
  ...
  getLanguages: ->
    ...
    @oxid_language = if !$.cookie("cat_oxid_language") then @language else $.cookie("cat_oxid_language")
    # console.log "read: #{@oxid_language}"
