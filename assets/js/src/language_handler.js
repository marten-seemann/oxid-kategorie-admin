...
(function() {
  ...
  window.LanguageHandler = (function() {
    ...
    LanguageHandler.prototype.setLanguageCookies = function() {
      $.cookie("cat_language", this.language, {
        expires: 365
      });
      return $.cookie("cat_oxid_language", this.oxid_language, {
        expires: 365
      });
    };
    ...
    LanguageHandler.prototype.getLanguages = function() {
      ...
      this.oxid_language = !$.cookie("cat_oxid_language") ? this.language : $.cookie("cat_oxid_language");
